object frmFormRelQtdeChamadosAnalistasDet: TfrmFormRelQtdeChamadosAnalistasDet
  Left = 175
  Top = 195
  Width = 1183
  Height = 480
  Caption = 
    'FI Sistemas - Chamados [ Relat'#243'rio Chamados por Analistas - Deta' +
    'lhado ]'
  Color = clBtnFace
  ...
  object QuickRep1: TQuickRep
    ...
    DataSet = dmDados.cdsRel_QtdeAnalistasDet
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -13
    Font.Name = 'Arial'
    ...
    object QRBand2: TQRBand
      ...
      object QRLabel7: TQRLabel
        ...
        AutoSize = True
        AutoStretch = False
        Caption = 'RELAT'#211'RIO DE CHAMADOS POR ANALISTAS [ QTDE ] DETALHADO'
        Color = clWhite
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -16
